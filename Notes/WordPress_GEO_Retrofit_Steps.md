...
- Rank Math filters และ hooks: [https://rankmath.com/kb/filters-hooks-api-developer/](https://rankmath.com/kb/filters-hooks-api-developer/)
- Rank Math variables (`%title%`, `%sitename%`, `%sitedesc%`, `%excerpt%`): [https://rankmath.com/kb/variables/](https://rankmath.com/kb/variables/)
- WordPress Child Themes: [https://developer.wordpress.org/themes/advanced-topics/child-themes/](https://developer.wordpress.org/themes/advanced-topics/child-themes/)
- `rest_pre_insert_{$post_type}`: [https://developer.wordpress.org/reference/hooks/rest_pre_insert_this-post_type/](https://developer.wordpress.org/reference/hooks/rest_pre_insert_this-post_type/)
- Schema.org Service, Offer, FAQPage: [https://schema.org/Service](https://schema.org/Service)
- Google Structured data general guidelines: [https://developers.google.com/search/docs/appearance/structured-data/sd-policies](https://developers.google.com/search/docs/appearance/structured-data/sd-policies)