...
นี่คือวิธีการเขียนโค้ดเพื่อนำไปวางในไฟล์ **robots.txt** ของคุณ เพื่อ บล็อกการนำไปเทรนโมเดล แต่ยังยอมให้เข้ามาเก็บเนื้อหาไปทำ Citation (อ้างอิงลิ้งก์) ของแต่ละค่าย

โค้ดสำหรับค่ายใหญ่ทั้งหมด (Copy ไปใช้งานได้เลย)
```txt
# ==========================================
# 1. GOOGLE (Gemini)
# ==========================================
# บล็อกไม่ให้นำข้อมูลไปเทรน AI / Gemini
User-agent: Google-Extended
Disallow: /

# อนุญาตให้ Googlebot เข้ามาเก็บข้อมูลไปทำ Search และ AI Overviews (ยังได้ทราฟฟิก)
...
# 2. OPENAI (ChatGPT)
# ==========================================
# บล็อกไม่ให้นำข้อมูลไปเทรน AI (GPT-4, GPT-5)
User-agent: GPTBot
Disallow: /

# อนุญาตให้ดึงข้อมูลไปอ้างอิงและทำลิงก์ Citation ใน ChatGPT Search
...
# 3. ANTHROPIC (Claude)
# ==========================================
# บล็อกไม่ให้นำข้อมูลไปเทรน AI
User-agent: ClaudeBot
Disallow: /

# อนุญาตให้ดึงข้อมูลไปแสดงผลค้นหาและอ้างอิงใน Claude
...
# 4. PERPLEXITY
# ==========================================
# หมายเหตุ: Perplexity ไม่มีโมเดลพื้นฐานของตัวเอง บอทของเขาจึงใช้สำหรับ "การค้นหาเพื่ออ้างอิงแหล่งที่มาเท่านั้น" 
# ไม่ได้เอาข้อมูลไปเก็บเพื่อเทรนโมเดล ดังนั้นจึงแนะนำให้ "เปิดให้เข้าถึง" เพื่อให้ได้ยอดคลิกกลับมายังเว็บครับ
User-agent: PerplexityBot
Allow: /
```

หลังจากที่คุณนำโค้ดด้านบนไปอัปเดตลงในไฟล์ robots.txt ของเว็บไซต์แล้ว บอทแต่ละตัวจะใช้เวลาประมาณ 24 ชั่วโมง ในการเข้ามาอ่านไฟล์ใหม่เพื่อรับทราบและเปลี่ยนพฤติกรรมการเข้าถึงหน้าเว็บของคุณ
